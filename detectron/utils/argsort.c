...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "detectron.utils.argsort"
}
END: Cython Metadata */
...
#define __PYX_HAVE__detectron__utils__argsort
#define __PYX_HAVE_API__detectron__utils__argsort
#include <string.h>
#include <stdio.h>
...
/* "detectron/utils/argsort.pyx":16
 * 
 ...
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_9detectron_5utils_7argsort_FLOAT_t;

/* "detectron/utils/argsort.pyx":17
 * # ctypedef cnp.float64_t FLOAT_t
 * ctypedef cnp.float32_t FLOAT_t
 * ctypedef cnp.intp_t INT_t             # <<<<<<<<<<<<<<
 * ctypedef cnp.ulong_t INDEX_t
 ...
 */
typedef __pyx_t_5numpy_intp_t __pyx_t_9detectron_5utils_7argsort_INT_t;

/* "detectron/utils/argsort.pyx":18
 * ctypedef cnp.float32_t FLOAT_t
 * ctypedef cnp.intp_t INT_t
 * ctypedef cnp.ulong_t INDEX_t             # <<<<<<<<<<<<<<
 * ctypedef cnp.uint8_t BOOL_t
 * 
 */
typedef __pyx_t_5numpy_ulong_t __pyx_t_9detectron_5utils_7argsort_INDEX_t;

/* "detectron/utils/argsort.pyx":19
 * ctypedef cnp.intp_t INT_t
 * ctypedef cnp.ulong_t INDEX_t
 * ctypedef cnp.uint8_t BOOL_t             # <<<<<<<<<<<<<<
 * 
 ...
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_9detectron_5utils_7argsort_BOOL_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_t_9detectron_5utils_7argsort_Sorter;

/* "detectron/utils/argsort.pyx":26
 ...
 */
struct __pyx_t_9detectron_5utils_7argsort_Sorter {
  __pyx_t_9detectron_5utils_7argsort_INT_t index;
  __pyx_t_9detectron_5utils_7argsort_FLOAT_t value;
};
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_9detectron_5utils_7argsort_FLOAT_t(PyObject *);

/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_9detectron_5utils_7argsort_INT_t(PyObject *);
...
/* Module declarations from 'detectron.utils.argsort' */
...
static int __pyx_f_9detectron_5utils_7argsort__compare(const void *, const void *); /*proto*/
static void __pyx_f_9detectron_5utils_7argsort_cyargsort(__Pyx_memviewslice, struct __pyx_t_9detectron_5utils_7argsort_Sorter *); /*proto*/
static PyObject *__pyx_f_9detectron_5utils_7argsort_argsort(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_9detectron_5utils_7argsort_FLOAT_t = { "FLOAT_t", NULL, sizeof(__pyx_t_9detectron_5utils_7argsort_FLOAT_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_9detectron_5utils_7argsort_INT_t = { "INT_t", NULL, sizeof(__pyx_t_9detectron_5utils_7argsort_INT_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_9detectron_5utils_7argsort_INT_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_9detectron_5utils_7argsort_INT_t), 0 };
#define __Pyx_MODULE_NAME "detectron.utils.argsort"
extern int __pyx_module_is_main_detectron__utils__argsort;
int __pyx_module_is_main_detectron__utils__argsort = 0;

/* Implementation of 'detectron.utils.argsort' */
...
static PyObject *__pyx_pf_9detectron_5utils_7argsort_argsort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_order); /* proto */
...
/* "detectron/utils/argsort.pyx":30
 *     FLOAT_t value
 * 
...
static int __pyx_f_9detectron_5utils_7argsort__compare(const void *__pyx_v_a, const void *__pyx_v_b) {
  __pyx_t_9detectron_5utils_7argsort_FLOAT_t __pyx_v_v;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("_compare", 0);

  /* "detectron/utils/argsort.pyx":31
 * 
 * cdef int _compare(const_void *a, const_void *b):
 *     cdef FLOAT_t v = ((<Sorter*>a)).value-((<Sorter*>b)).value             # <<<<<<<<<<<<<<
 *     if v < 0: return -1
 *     if v >= 0: return 1
 */
  __pyx_v_v = (((struct __pyx_t_9detectron_5utils_7argsort_Sorter *)__pyx_v_a)->value - ((struct __pyx_t_9detectron_5utils_7argsort_Sorter *)__pyx_v_b)->value);

  /* "detectron/utils/argsort.pyx":32
 * cdef int _compare(const_void *a, const_void *b):
 *     cdef FLOAT_t v = ((<Sorter*>a)).value-((<Sorter*>b)).value
 *     if v < 0: return -1             # <<<<<<<<<<<<<<
 *     if v >= 0: return 1
 ...
 */
  ...
  /* "detectron/utils/argsort.pyx":33
 *     cdef FLOAT_t v = ((<Sorter*>a)).value-((<Sorter*>b)).value
 *     if v < 0: return -1
 *     if v >= 0: return 1             # <<<<<<<<<<<<<<
 * 
...
/* "detectron/utils/argsort.pyx":35
 *     if v >= 0: return 1
 * 
 * cdef void cyargsort(FLOAT_t[:] data, Sorter * order):             # <<<<<<<<<<<<<<
 *     cdef INT_t i
...
static void __pyx_f_9detectron_5utils_7argsort_cyargsort(__Pyx_memviewslice __pyx_v_data, struct __pyx_t_9detectron_5utils_7argsort_Sorter *__pyx_v_order) {
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_v_i;
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_v_n;
  __Pyx_RefNannyDeclarations
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_t_1;
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  __Pyx_RefNannySetupContext("cyargsort", 0);

  /* "detectron/utils/argsort.pyx":37
 * cdef void cyargsort(FLOAT_t[:] data, Sorter * order):
 *     cdef INT_t i
 *     cdef INT_t n = data.shape[0]             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  ...
  /* "detectron/utils/argsort.pyx":38
 *     cdef INT_t i
 *     cdef INT_t n = data.shape[0]
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         order[i].index = i
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "detectron/utils/argsort.pyx":39
 *     cdef INT_t n = data.shape[0]
 *     for i in range(n):
 *         order[i].index = i             # <<<<<<<<<<<<<<
 *         order[i].value = data[i]
 ...
 */
    ...
    /* "detectron/utils/argsort.pyx":40
 *     for i in range(n):
 *         order[i].index = i
 *         order[i].value = data[i]             # <<<<<<<<<<<<<<
 *     qsort(<void *> order, n, sizeof(Sorter), _compare)
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    (__pyx_v_order[__pyx_v_i]).value = (*((__pyx_t_9detectron_5utils_7argsort_FLOAT_t *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_3 * __pyx_v_data.strides[0]) )));
  }

  /* "detectron/utils/argsort.pyx":41
 *         order[i].index = i
 *         order[i].value = data[i]
 *     qsort(<void *> order, n, sizeof(Sorter), _compare)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  qsort(((void *)__pyx_v_order), __pyx_v_n, (sizeof(struct __pyx_t_9detectron_5utils_7argsort_Sorter)), __pyx_f_9detectron_5utils_7argsort__compare);
...
/* "detectron/utils/argsort.pyx":43
 *     qsort(<void *> order, n, sizeof(Sorter), _compare)
 * 
 * cpdef argsort(FLOAT_t[:] data, INT_t[:] order):             # <<<<<<<<<<<<<<
 *     cdef INT_t i
...
static PyObject *__pyx_pw_9detectron_5utils_7argsort_1argsort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_9detectron_5utils_7argsort_argsort(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_order, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_v_i;
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_v_n;
  struct __pyx_t_9detectron_5utils_7argsort_Sorter *__pyx_v_order_struct;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_t_1;
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_t_2;
  __pyx_t_9detectron_5utils_7argsort_INT_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  __Pyx_RefNannySetupContext("argsort", 0);

  /* "detectron/utils/argsort.pyx":45
 * cpdef argsort(FLOAT_t[:] data, INT_t[:] order):
 *     cdef INT_t i
 *     cdef INT_t n = data.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "detectron/utils/argsort.pyx":46
 *     cdef INT_t i
 *     cdef INT_t n = data.shape[0]
 *     cdef Sorter *order_struct = <Sorter *> malloc(n * sizeof(Sorter))             # <<<<<<<<<<<<<<
 *     cyargsort(data, order_struct)
 *     for i in range(n):
 */
  __pyx_v_order_struct = ((struct __pyx_t_9detectron_5utils_7argsort_Sorter *)malloc((__pyx_v_n * (sizeof(struct __pyx_t_9detectron_5utils_7argsort_Sorter)))));

  /* "detectron/utils/argsort.pyx":47
 *     cdef INT_t n = data.shape[0]
 *     cdef Sorter *order_struct = <Sorter *> malloc(n * sizeof(Sorter))
 *     cyargsort(data, order_struct)             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  __pyx_f_9detectron_5utils_7argsort_cyargsort(__pyx_v_data, __pyx_v_order_struct);

  /* "detectron/utils/argsort.pyx":48
 *     cdef Sorter *order_struct = <Sorter *> malloc(n * sizeof(Sorter))
 *     cyargsort(data, order_struct)
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         order[i] = order_struct[i].index
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "detectron/utils/argsort.pyx":49
 *     cyargsort(data, order_struct)
 *     for i in range(n):
 *         order[i] = order_struct[i].index             # <<<<<<<<<<<<<<
 *     free(order_struct)
 */
    ...
    __pyx_t_4 = __pyx_v_i;
    *((__pyx_t_9detectron_5utils_7argsort_INT_t *) ( /* dim=0 */ (__pyx_v_order.data + __pyx_t_4 * __pyx_v_order.strides[0]) )) = __pyx_t_3;
  }

  /* "detectron/utils/argsort.pyx":50
 *     for i in range(n):
 *         order[i] = order_struct[i].index
 *     free(order_struct)             # <<<<<<<<<<<<<<
 */
...
/* Python wrapper */
static PyObject *__pyx_pw_9detectron_5utils_7argsort_1argsort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9detectron_5utils_7argsort_1argsort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("argsort (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_order)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("argsort", 1, 2, 2, 1); __PYX_ERR(0, 43, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "argsort") < 0)) __PYX_ERR(0, 43, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_9detectron_5utils_7argsort_FLOAT_t(values[0]); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_order = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_9detectron_5utils_7argsort_INT_t(values[1]); if (unlikely(!__pyx_v_order.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("argsort", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 43, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("detectron.utils.argsort.argsort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9detectron_5utils_7argsort_argsort(__pyx_self, __pyx_v_data, __pyx_v_order);
...
static PyObject *__pyx_pf_9detectron_5utils_7argsort_argsort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_order) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_order.memview)) { __Pyx_RaiseUnboundLocalError("order"); __PYX_ERR(0, 43, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9detectron_5utils_7argsort_argsort(__pyx_v_data, __pyx_v_order, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "detectron.utils.argsort.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "detectron.utils.argsort.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "detectron.utils.argsort.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "detectron.utils.argsort._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"argsort", (PyCFunction)__pyx_pw_9detectron_5utils_7argsort_1argsort, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_detectron__utils__argsort) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "detectron.utils.argsort")) {
      if (unlikely(PyDict_SetItemString(modules, "detectron.utils.argsort", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "detectron/utils/argsort.pyx":10
 * 
 ...
 */
  ...
  /* "detectron/utils/argsort.pyx":13
 * from libc.stdlib cimport malloc, free
 * from cython cimport view
 * cnp.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init detectron.utils.argsort", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init detectron.utils.argsort");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
      static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_9detectron_5utils_7argsort_FLOAT_t(PyObject *obj) {
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 PyBUF_RECORDS, 1,
                                                 &__Pyx_TypeInfo_nn___pyx_t_9detectron_5utils_7argsort_FLOAT_t, stack,
                                                 &result, obj);
...
/* ObjectToMemviewSlice */
      static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_9detectron_5utils_7argsort_INT_t(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 PyBUF_RECORDS, 1,
                                                 &__Pyx_TypeInfo_nn___pyx_t_9detectron_5utils_7argsort_INT_t, stack,
                                                 &result, obj);
    if (unlikely(retcode == -1))
        goto __pyx_fail;
    return result;
