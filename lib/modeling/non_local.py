...
# Modified from official non-local code:
...
def space_only_nonlocal(
    ...
    phi, phi_shape_4d = model.Reshape(phi, [phi + '_re', phi + '_shape4d'], shape=(batch_size, dim_inner, -1))
    g, g_shape_4d = model.Reshape(g, [g + '_re', g + '_shape4d'], shape=(batch_size, dim_inner, -1))

    # # e.g., (8, 1024, 784) * (8, 1024, 784) => (8, 784, 784)
    # e.g., (8, 1024, 196) * (8, 1024, 196) => (8, 196, 196)
